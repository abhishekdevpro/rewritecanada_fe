...
//               className="text-blue-950 hover:text-emerald-500 focus:outline-none px-3 py-2 rounded-md text-sm font-medium"
//             >
//               <svg
//                 className="w-6 h-6"
//                 fill="none"
          ...
          <div className="hidden md:flex items-center gap-4">
            {isLoggedIn ? (
              <div className="relative">
                <button
                  onClick={toggleDropdown}
                  className="flex items-center bg-blue-950 hover:bg-emerald-500 text-white px-4 py-2 text-md font-semibold border-2 rounded-xl"
                >
                  <img
                    src={
                      photo
              ...
              <>
                <Link
                  href="/login2"
                  className="bg-blue-950 hover:bg-emerald-500 text-white  px-4 py-2 text-md font-semibold border-2 rounded-xl"
                >
                  {t("login")}
                </Link>
                {/* <Link
