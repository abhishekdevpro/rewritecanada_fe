...
//           Welcome to Rewrite Canada. These terms and conditions outline the rules and
...
//           <li>
//             Client: Any individual or entity using the services of Rewrite Canada.
//           </li>
//           <li>Company: Rewrite Canada.</li>
//           <li>
...
//         <ul className="list-inside list-disc pl-4 text-base sm:text-lg">
//           <li>
//             All content, materials, and services provided by Rewrite Canada are
...
//         <ul className="list-inside list-disc pl-4 text-base sm:text-lg">
//           <li>
//             Rewrite Canada respects the privacy and confidentiality of its clients.
//           </li>
//           <li>
...
//         <ul className="list-inside list-disc pl-4 text-base sm:text-lg">
//           <li>
//             Rewrite Canada will not be liable for any direct, indirect, incidental,
...
//         <ul className="list-inside list-disc pl-4 text-base sm:text-lg">
//           <li>
//             Rewrite Canada reserves the right to modify or update these terms and
...
//             accordance with the laws of the jurisdiction in which Rewrite Canada
//             operates.
//           </li>
//           <li>
    ...
    <div>
      ...
      <div className="m-4 sm:mx-10 lg:mx-40 p-4 sm:p-6 shadow-2xl">
        ...
        <p className="text-base sm:text-lg">
          {/* {termsData.contact}: */}
          Email:{" "}
          <a href="dummy@rewritecanada.ca" className="text-blue-500">
            dummy@rewritecanada.ca
          </a>
        </p>
      </div>
