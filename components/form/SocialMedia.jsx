...
//               aria-label="Remove"
//               className="p-2 text-black bg-red-700 rounded-lg text-xl mb-2"
//             >
//               <MdRemoveCircle />
//             </button>
//           </div>
...
//         className="p-2 text-black bg-black rounded-lg text-sm"
//       >
...
const SocialMedia = () => {
  ...
  return (
    <div className="flex flex-col w-full max-w-5xl mx-auto md:mt-10 md:px-10 rounded-lg shadow-md max-h-[400px] overflow-y-auto">
      <div className="mb-6">
